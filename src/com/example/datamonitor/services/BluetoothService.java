...
/**
 * AccControlActivity 
 * Service subclass，support Bluetooth connetcion and communication.
 * Communicate with Activities using Broadcast
 * The Running label also inclued in this service
 * @author LWang
...
public class BluetoothService {
	...
	public BluetoothService(Context context, Handler handler) {
        ...
        mState = R.string.BT_SERVICE_STATE_NONE;
        mHandler = handler;
    }
    ...
    public synchronized void start() {
        ...
        setState(R.string.BT_SERVICE_STATE_NONE);
    }
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(R.string.BT_SERVICE_MSG_STATE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connect(BluetoothDevice device) {
        ...
        if (mState == R.string.BT_SERVICE_CONNECTING) {
            if (mConnectThread != null) {
            	mConnectThread.cancel(); mConnectThread = null;
            }
        }
        ...
        setState(R.string.BT_SERVICE_CONNECTING);
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
         ...
         */
        Message msg = mHandler.obtainMessage(R.string.BT_MSG_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(null, device.getName()); 
        msg.setData(bundle);
        mHandler.sendMessage(msg);

        setState(R.string.BT_SERVICE_CONNECTED);
    ...
    private void connectionFailed() {
         ...
         */
        Message msg = mHandler.obtainMessage(R.string.BT_SERVICE_MSG_TOAST);
        Bundle bundle = new Bundle();
    ...
    private class ConnectThread extends Thread {
		...
		public void run() {
            ...
            try {
                ...
                mmSocket.connect();
                Log.e("BUGBUGBUG","ConnectThread->socket.connect()");
            } catch (IOException e) {
                connectionFailed();
                // Close the socket
                try {
                    mmSocket.close();
                    Log.e("BUGBUGBUG","ConnectThread->socket.close()");
                } catch (IOException e2) {
                    Log.e(TAG, "ConnectThread.run(): unable to close() socket during connection failure", e2);
                }
                
                // Start the service over to restart listening mode
                Log.e("BUGBUGBUG","ConnectThread.start()");
    ...
    private class ConnectedThread extends Thread {
         ...
         * contents of the message to detect transmission errors.
         */
		...
		public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(R.string.BT_SERVICE_MSG_READ, bufferIndex, 0, buffer)
                            .sendToTarget();
